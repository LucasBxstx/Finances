...
export class StatisticsComponent {
  ...
  public readonly yearlyColumnChartData$: Observable<EChartsOption> = this.transactionData$.pipe(map((transactionData)=>{
    const yearlyColumnChartData = calculateYearlyColumnChartData(transactionData?.transactions ?? [], transactionData?.oldestTransactionDate);
    const chartData = getYearlyColumnChartData(yearlyColumnChartData);
